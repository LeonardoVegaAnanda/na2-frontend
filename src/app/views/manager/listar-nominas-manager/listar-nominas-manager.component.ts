...
@Component({
  selector: 'app-listar-nominas-manager',
  templateUrl: './listar-nominas-manager.component.html',
  styleUrls: ['./listar-nominas-manager.component.css']
})
export class ListarNominasManagerComponent {
  fecha = new Date();
  trabajadores = [];
  listaNominas: any = [];
  idTrabajador: any;
  ...
  detalleNomina(idTrabajador, idNomina) {
    this.router.navigate(['/manager/nominas/' + idNomina], {
      queryParams: {
        idNomina: idNomina,
