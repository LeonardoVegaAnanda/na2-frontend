...
@Component({
  selector: 'app-lista-quejas-manager',
  templateUrl: './lista-quejas-manager.component.html',
  styleUrls: ['./lista-quejas-manager.component.css']
})
export class ListaQuejasManagerComponent {
fecha = new Date();
  quejaNueva = {
    fechaQueja: Date(),
    tipo_Queja: '',
