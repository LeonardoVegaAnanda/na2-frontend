...
@Component({
  selector: 'app-detalle-queja-worker',
  templateUrl: './detalle-queja-worker.component.html',
  styleUrls: ['./detalle-queja-worker.component.css']
})
export class DetalleQuejaWorkerComponent {
  id = 0;
